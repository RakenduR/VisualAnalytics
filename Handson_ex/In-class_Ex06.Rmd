...
jobs <- read_sf("data/wkt/Jobs.csv", options = "GEOM_POSSIBLE_NAMES=location")

participants <- read_sf("data/wkt/participants.csv", options = "GEOM_POSSIBLE_NAMES=location")
...
tmap_mode - view -> interactive (zoom)
